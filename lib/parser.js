                ...
                for (const [idx, token] of parsed.entries()) {
                    ...
                    if (token.type === 'Var') {
                        ...
                        switch (token.value) {
                            ...
                            case 'mod':
                                {
                                    ...
                                    if (!arg1 || !arg2)
                                        break;
                                    const parsed1 = parseFloat(arg1);
                                    const parsed2 = parseFloat(arg2);
                                    result = ((parsed1 % parsed2) + parsed2) % parsed2;
                                }
                                break;
                            case 'fac':
                                {
                            ...
                            case 'round':
                                {
                                    const arg = (_o = args[0]) === null || _o === void 0 ? void 0 : _o.value;
                                    if (!arg)
                                        break;
                                    let parsed = parseFloat(arg);
                                ...
                                break;
                            case 'int': {
                                const arg = (_p = args[0]) === null || _p === void 0 ? void 0 : _p.value;
                                if (!arg)
                                    break;
